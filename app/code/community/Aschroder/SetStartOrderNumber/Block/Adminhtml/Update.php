...
class Aschroder_SetStartOrderNumber_Block_Adminhtml_Update extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    {
        $layout         = $this->getElement()->getForm()->getParent()->getLayout();
        $buttonBlock    = $layout->createBlock('adminhtml/widget_button');
